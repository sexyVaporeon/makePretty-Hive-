...
<div class="clearfix">
<p id="heroQuote">
<img id="imageHeroRight" src={AdventureImage} alt="Continous learning knowledge journey that will be travelled"/> 
...
<div class="clearfix">
<p id="heroQuote">
<img id="imageHeroLeft" src={LevelUpImage} alt="Continous learning knowledge journey that will be travelled"/> 
...
<div class="clearfix">
<p id="heroQuote">
 <img id="imageHeroRight" src={SideQuestImage} alt="Continous learning knowledge journey that will be travelled"/> 
